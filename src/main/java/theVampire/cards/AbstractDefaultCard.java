...
public abstract class AbstractDefaultCard extends CustomCard {
    ...
    public int bloodVariable;
    public int bloodBaseVariable;
    ...
    public boolean upgradedBloodVariable;
    public boolean isBloodVariableModified;
    ...
    public void displayUpgrades() { // Display the upgrade - when you click a card to upgrade it
        ...
        if (upgradedBloodVariable) {
            bloodVariable = bloodBaseVariable;
            isBloodVariableModified = true;
        }
    ...
    public void upgradeBloodVariable(int amount) {
        bloodBaseVariable += amount;
        bloodVariable = bloodBaseVariable;
        upgradedBloodVariable = true;
    }
}